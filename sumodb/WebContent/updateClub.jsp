		...
		<table>
			<tbody>
				<tr>
					...
					<td><input type="text" name="clubName" value="${UPDATE_CLUB.name}" /></td>
				</tr>
				
				<tr>
					<td><label>Starting year</label></td>
					<td><input type="text" name="startingYear" value="${UPDATE_CLUB.startingYear}" /></td>
				</tr>
				
				<tr>
					<td><label>City</label></td>
					<td><input type="text" name="city" value="${UPDATE_CLUB.city}" /></td>
				</tr>

...
<body>
	...
	<div align="center">
		...
		<br /> <input style="align: center;" type="button" value="Add coach"
			onclick="window.location.href='AddCoach'; return false;" /> <br />
		<br />
		...
		<table class="list">
			...
			<c:forEach var="tempCoach" items="${ALL_COACHES}">
				...
				<tr>
					...
					<td><a href="${updateCoach}"><i class="fa fa-refresh"></i></a>
						| <a href="${deleteCoach}"
